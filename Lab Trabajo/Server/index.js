...
Frases[2] = "Haz el amor y no la guerra (John Lennon)";
Frases[3] = "Aprende a vivir y sabrás morir bien (Confucio)";
Frases[4] = "La medida del amor es amar sin medida (San Agustín)";
var Q = Frases.length;
...
app.post('/loadImg', upload.single('files'), (req, res, next) => {
    ...
    editImg('public/' + file.filename, Frases[numAleatorio]);
